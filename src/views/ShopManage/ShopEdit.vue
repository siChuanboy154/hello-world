  ...
  <div class="append-shop">
    <el-card>
      ...
      >
        ...
        <!-- 提交 -->
        <el-form-item>
          <el-button type="primary" @click="submitForm('addGoodsForm')">立即修改</el-button>
...
<script>
import { goodsEdit } from "@/api/shopManage";
export default {
  data() {
    return {
  ...
  methods: {
    ...
    resetForm(formName) {
      ...
      this.addGoodsForm.goodsname = goods.goodsname;
      this.addGoodsForm.goodscategory = goods.goodscategory;
      this.addGoodsForm.isPromotion = goods.isPromotion;
      this.addGoodsForm.goodsdesc = goods.goodsdesc;
      this.addGoodsForm.imgUrl = goods.imgUrl;
      this.addGoodsForm.id = goods.id;
      this.addGoodsForm.goodsfeature = JSON.parse(goods.goodsfeature);
      if (JSON.parse(goods.standard.standard === "单规格")) {
        this.addGoodsForm.standard = JSON.parse(goods.standard.standard);
        this.addGoodsForm.shoppingFee = JSON.parse(goods.standard.shoppingFee);
        this.addGoodsForm.price = JSON.parse(goods.standard.price);
      } else {
        this.addGoodsForm.standard = "多规格";
        this.multipleShop = JSON.parse(goods.standard);
      }
    },
    // 上传图片成功的回调
